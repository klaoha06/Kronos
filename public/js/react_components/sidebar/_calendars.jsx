define(['react', 'jquery', 'jquery-ui-custom', 'react-router', 'stores/CalendarStore' , 'actions/CalendarActions', 'utils/CalendarWebAPIUtils', 'magnific-popup'], function(React, $, jqueryUI, Router, CalendarStore, CalendarActions, CalendarAPI, magnificPopup){
